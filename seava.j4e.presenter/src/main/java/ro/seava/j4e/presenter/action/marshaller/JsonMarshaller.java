 ...
 */
package ro.seava.j4e.presenter.action.marshaller;
...
import ro.seava.j4e.api.action.impex.IExportInfo;
import ro.seava.j4e.api.action.query.IFilterRule;
import ro.seava.j4e.api.action.query.ISortToken;
import ro.seava.j4e.api.action.result.IActionResultDelete;
import ro.seava.j4e.api.action.result.IActionResultFind;
import ro.seava.j4e.api.action.result.IActionResultRpcData;
import ro.seava.j4e.api.action.result.IActionResultRpcFilter;
import ro.seava.j4e.api.action.result.IActionResultSave;
import ro.seava.j4e.api.action.result.IDsMarshaller;
import ro.seava.j4e.commons.action.query.FilterRule;
import ro.seava.j4e.commons.action.query.SortToken;
import ro.seava.j4e.presenter.action.impex.ExportInfo;

	<script>
		...
		Main.urlDs = Main.urlWeb + "${statics["ro.seava.j4e.api.Constants"].URL_DATA_DS}";
		Main.urlAsgn = Main.urlWeb + "${statics["ro.seava.j4e.api.Constants"].URL_DATA_ASGN}";
		Main.urlWorkflow = Main.urlWeb + "${statics["ro.seava.j4e.api.Constants"].URL_WORKFLOW}";
		Main.urlUiExtjs = Main.urlWeb + "${statics["ro.seava.j4e.api.Constants"].URL_UI_EXTJS}";
		Main.urlSession = Main.urlWeb + "${statics["ro.seava.j4e.api.Constants"].URL_SESSION}";
		Main.urlUpload = Main.urlWeb + "${statics["ro.seava.j4e.api.Constants"].URL_UPLOAD}";
